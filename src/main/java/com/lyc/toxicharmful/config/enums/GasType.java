...
@Getter
public enum GasType {
    METHANOL_TOLUENE_STYRENE_ACRYLIC_LPG_ETHYLENE("a25003", "甲醇、甲苯、苯乙烯、丙烯酸、LPG、乙烯", "%LEL", 25, 50),
    STYRENE_ETHYL_ACETATE_METHANOL_ACRYLIC_CHLOROPROPYLENE_TOLUENE("a30001", "苯乙烯、乙酸乙酯、甲醇、丙烯酸、氯丙烯、甲苯", "%LEL", 25, 50),
